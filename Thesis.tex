...
\acknowledgements{
A mi asesor de tesis, el Dr. Rogelio Dávila, por sus consejos en el desarrollo del presente trabajo.\\* 
A CONACYT por la beca que hizo posible mi estudio de posgrado.\\*
A mis maestros por todas sus enseñanzas.\\* 
A mi marido, Romeo, por su apoyo incondicional y motivación para culminar con éxito este proyecto.\\* 
A mis padres y hermanos, por creer en mí y estar a mi lado en todo momento.
}
...
\lhead{\emph{\leftmark}}  % Set the left side page header to "Introducción"
...
\input{Appendices/CalendarioActividades}	% Appendix Title
\input{Appendices/CodigoFuenteAppBusqueda}	% Appendix Title
