...
La compañía McKinsey\rq s publicó un estudio en Octubre de 2013 \cite{mckinsey}  en el que valora el potencial en términos económicos de siete sectores de actividad: educación, transporte, productos de consumo, energía eléctrica, petróleo, gas, salud y economía familiar. \\ 

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.8\textwidth]{Images/EstudioMckinsey}
    \caption{ Los datos abiertos pueden ayudar a generar mas de 3 billones de dólares al año en el mundo.}
\end{figure}

La investigación sugiere que esos siete sectores exclusivamente pudieran generar mas de 3 billones de dólares al año de los cuales 1,1 billón corresponde a Estados Unidos, 900.000 millones a Europa y los otros 1,7 billones al resto del mundo como resultado de la utilización de datos abiertos. \\
