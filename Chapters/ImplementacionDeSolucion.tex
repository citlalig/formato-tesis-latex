...
El código fuente completo puede ser consultado en el Apéndice \ref{SearchApp} Aplicación de Búsqueda (Código Fuente). \\
...
\centering
    ...
    \caption{Clases del proceso de Búsqueda} 
\end{figure}
...
Lucene provee una API para construir campos a través de las clases \\ \textbf{org.apache.lucene.document.Document} y \textbf{org.apache.lucene.document.Field}.  \\
La clase  \emph{Document}  representa una colección de objetos de tipo \emph{Field}.\\
\emph{Field} es la clase que contiene el contenido a ser indexado. \\
En la aplicación se utilizan lo campos ubicación de archivo, nombre de archivo, fecha de modificación y contenido para identificar un Documento. \\
...
Lucene provee un conjunto de analizadores que permiten tener control sobre este proceso. Algunos ayudan a ignorar palabras que no ayudan a distinguir un documento de otro por ejemplo la, el, en, y, etc o que convierten los \emph{token} a minúscula para favorecer la búsqueda.\\
...
Lucene provee las herramientas necesarias para realizar este proceso utilizando la clase \\
 ...
 \emph{IndexWriter} el el componente principal en el proceso de indexado. La clase crea un índice nuevo o abre un índice existente, y agrega, actualiza o elimina documentos de él. \\
...
\emph{IndexSearcher}  es el enlace principal hacia un índice y provee varios métodos de búsqueda. Es una clase que abre un índice en modo de sólo lectura y ofrece numerosos métodos de búsqueda. El resultado es un objeto de tipo TopDocs. \\
La clase: \textbf{org.apache.lucene.search.TopDocs} es simplemente un contenedor de punteros a los resultados de búsqueda ordenados por relevancia. \\
...
\section{Instrucciones para compilar el código fuente}
